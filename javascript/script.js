...
function updateTimer() {
  const targetDate = new Date("may 5, 2026 20:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const phoneNumber1 = '542974429703'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function () {
  // Definir los números de teléfono
  const recipientNumber1 = '542974429703'; // Número para el primer botón
