const CACHE_NAME = 'cache-v65'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v65',
    'estilos/styles.css?v65',
    'estilos/mediaQueries.css?v65',
    'javascript/script.js?v65',
